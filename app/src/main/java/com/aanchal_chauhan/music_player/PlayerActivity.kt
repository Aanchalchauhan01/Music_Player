...
import com.aanchal_chauhan.music_player.databinding.ActivityPlayerBinding
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.data?.scheme.contentEquals("content")){
            ...
            musicListPlayer.add(getMusicDetails(intent.data!!))
            Glide.with(this)
                .load(getImgArt(musicListPlayer[songPosition].path))
                .apply(RequestOptions().placeholder(R.drawable.music_player_icon_slash_screen).centerCrop())
                .into(binding.songImgPlayer)
            binding.songNamePlayer.text = musicListPlayer[songPosition].title
        }
        else initializeLayout()

        binding.backBtnPA.setOnClickListener { finish() }
        binding.playPauseBtnPlayer.setOnClickListener{
            if(isPlaying) pauseMusic() else playMusic()
        }
        binding.previousBtnPlayer.setOnClickListener { preNextSong(increment = false) }
        binding.nextBtnPlayer.setOnClickListener { preNextSong(increment = true) }
        ...
        binding.shareBtnPA.setOnClickListener {
            ...
            shareIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse(musicListPlayer[songPosition].path))
            startActivity(Intent.createChooser(shareIntent, "Sharing Music File!!"))
        }
        binding.favouriteBtnPA.setOnClickListener {
            fIndex = favouriteChecker(musicListPlayer[songPosition].id)
            if(isFavourite){
                isFavourite = false
                ...
                FavouriteActivity.favouriteSongs.add(musicListPlayer[songPosition])
            }
//            FavouriteActivity.favouritesChanged = true
    ...
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "NowPlaying" ->{
                ...
                if (isPlaying) binding.playPauseBtnPlayer.setIconResource(R.drawable.pause_icon)
                else binding.playPauseBtnPlayer.setIconResource(R.drawable.play_icon)
    ...
    private fun createMediaPlayer(){
        try {
            ...
            isPlaying = true
            binding.playPauseBtnPlayer.setIconResource(R.drawable.pause_icon)
            ...
            nowPlayingId = musicListPlayer[songPosition].id
    ...
    private fun pauseMusic(){
        ...
        binding.playPauseBtnPlayer.setIconResource(R.drawable.play_icon)
    ...
    override fun onDestroy() {
        super.onDestroy()
        if(musicListPlayer[songPosition].id == "Unknown" && !isPlaying) exitApplication()
    }
}