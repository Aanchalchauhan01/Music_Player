...
import com.aanchal_chauhan.music_player.databinding.FragmentNowPlayingBinding
...
class NowPlaying : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.nextBtnNP.setOnClickListener {
            ...
            binding.songNameNP.text = PlayerActivity.musicListPlayer[PlayerActivity.songPosition].title
    ...
    private fun playMusic(){
        ...
        PlayerActivity.musicService!!.showNotification(R.drawable.pause_icon)
        PlayerActivity.binding.nextBtnPlayer.setIconResource(R.drawable.pause_icon)
    ...
    private fun pauseMusic(){
        ...
        PlayerActivity.binding.nextBtnPlayer.setIconResource(R.drawable.play_icon)
